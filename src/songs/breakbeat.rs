...
const CELL_KICK: Cell = Cell::note(PROJECT::KICK, Pitch(0x1000));
const CELL_KICK_HALF: Cell = Cell::note_vol(PROJECT::KICK, Pitch(0x1000), Volume::HALF);
const CELL_SNARE: Cell = Cell::note(PROJECT::SNARE, Pitch(0x1000));
const CELL_HAT_QUART: Cell = Cell::note_vol(PROJECT::HAT, Pitch(0x1000), Volume::QUARTER);
const CELL_HAT_HALF: Cell = Cell::note_vol(PROJECT::HAT, Pitch(0x1000), Volume::HALF);
const CELL_HAT: Cell = Cell::note(PROJECT::HAT, Pitch(0x1000));
